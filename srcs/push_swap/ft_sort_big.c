...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/15 20:12:34 by athekkan          #+#    #+#             */
/*   Updated: 2024/02/09 19:28:50 by athekkan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort_b_to_3(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (ft_lstsize(*stack_a) > 3 && !ft_checksorted(*stack_a))
	{
		...
		while (i >= 0)
		{
			if (i == ft_count_rarb(*stack_a, *stack_b, tmp->nbr))
				i = ft_apply_rarb(stack_a, stack_b, tmp->nbr, 'a');
			else if (i == ft_count_rrarrb(*stack_a, *stack_b, tmp->nbr))
				i = ft_apply_rrarrb(stack_a, stack_b, tmp->nbr, 'a');
			else if (i == ft_count_rarrb(*stack_a, *stack_b, tmp->nbr))
				i = ft_apply_rarrb(stack_a, stack_b, tmp->nbr, 'a');
			else if (i == ft_count_rrarb(*stack_a, *stack_b, tmp->nbr))
...
t_stack	*ft_sort_b(t_stack **stack_a)
{
	...
	if (ft_lstsize(*stack_a) > 3 && !ft_checksorted(*stack_a))
		ft_push_b(stack_a, &stack_b, 0);
	if (ft_lstsize(*stack_a) > 3 && !ft_checksorted(*stack_a))
		ft_sort_b_to_3(stack_a, &stack_b);
...
t_stack	**ft_sort_a(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (*stack_b)
	{
		...
		while (i >= 0)
		{
			if (i == ft_count_rarb_a(*stack_a, *stack_b, tmp->nbr))
				i = ft_apply_rarb(stack_a, stack_b, tmp->nbr, 'b');
			else if (i == ft_count_rarrb_a(*stack_a, *stack_b, tmp->nbr))
				i = ft_apply_rarrb(stack_a, stack_b, tmp->nbr, 'b');
			else if (i == ft_count_rrarrb_a(*stack_a, *stack_b, tmp->nbr))
				i = ft_apply_rrarrb(stack_a, stack_b, tmp->nbr, 'b');
			else if (i == ft_count_rrarb_a(*stack_a, *stack_b, tmp->nbr))
